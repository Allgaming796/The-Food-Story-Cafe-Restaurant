...
const INITIAL_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    comment: "Ivory Banquet Hall hosted our family Roka ceremony flawlessly! We picked the Royal Gold theme with Saffron velvet drapes. The slow-cooked Dal Makhani and warm Brownies left everyone amazed. Sincere thanks to the catering stewards!",
    date: "June 08, 2026",
