...
const DECOR_THEMES: BanquetTheme[] = [
  {
    id: "theme-gold",
    name: "Royal Gold Tradition",
    description: "Saffron and deep maroon velvet backdrops accompanied by majestic brass candelabras, heavy polished gold throne alignments, and marigold strings.",
    pricePerGuest: 100,
    image: "✨",
    color: "#D4AF37",
    highlights: ["Saffron Velvet Drapes", "Solid Brass Centerpieces", "Traditional Indian Seating Options"],
  },
  {
    id: "theme-pastel",
    name: "Pastel Floral Haven",
    description: "Cascades of premium peach roses, pink hydrangeas, and lilies under soft peach tulle drapes, warm copper spotlights, and floral gates.",
    pricePerGuest: 150,
    image: "🌸",
    color: "#E29B7A",
    highlights: ["Fresh Flora Suspended Curtains", "Silk Soft-backdrops", "Fairy Dust Sparkle Lighting"],
  },
  {
    id: "theme-ivory",
    name: "Elegant Ivory Minimalist",
    description: "Prestige luxury with crisp white orchids, modern crystal backdrops, floating glass tea lights, and pure mercury silver tableware.",
    pricePerGuest: 120,
    image: "🤍",
    color: "#EAE6DF",
    highlights: ["Orchid Archways", "Floating Table Candles", "Premium Flatware"],
  },
  {
    id: "theme-neon",
    name: "Neon Party Blast",
    description: "Stellar twilight setting using custom neon slogan lettering, glowing geometric LED columns, retro blacklight filters, and modern club configurations.",
    pricePerGuest: 140,
    image: "⚡",
    color: "#4DEEEA",
    highlights: ["Custom Neon Signboard", "LED Lounge Setup", "Strobe Party Ambience"],
  }
];
